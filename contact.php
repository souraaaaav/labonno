                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-md-6">
                                <div class="banner-content">
                                    <h1 class="display-2 text-uppercase text-dark pb-5">Contact us</h1>
                                    <a href="index.php"
        ...
        <div class="box-root flex-flex flex-direction--column" style="flex-grow: 1;">
            ...
            <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
                <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center">
                    <h1><a href="apply.php" rel="dofollow">Contact With Us</a></h1>
                </div>
                <div class="container" style="    border-radius: 4px;
    box-shadow: rgba(60, 66, 87, 0.12) 0px 7px 14px 0px, rgba(0, 0, 0, 0.12) 0px 3px 6px 0px;">

                    <div class="formbg-inner padding-horizontal--48">
                        <span class="padding-bottom--15">Enter your Query</span>
                        <form id="stripe-login" action="save_contact.php" method="POST">
                            ...
                            <div class="field padding-bottom--24">
                                ...
                                <textarea name="query" rows="4" required style="width:100%;"></textarea>
                            </div>
