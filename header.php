            ...
            <ul id="navbar" class="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="dress.php" class="dropdown-item">Dress</a>
                  </li>
                  <li>
                    <a href="jewelry.php" class="dropdown-item">Jewelry</a>
                  </li>
                  <li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="formal.php" class="dropdown-item">Formal</a>
                  </li>
                  <li>
                    <a href="casual.php" class="dropdown-item">Casual</a>
                  </li>
                  <li>
              ...
              <li class="nav-item">
                <a class="nav-link me-4" href="kids.php">Kids</a>
              </li>
              <li class="nav-item">
              <div class="user-items ps-5 d-flex">
                <a class="nav-link me-4" href="apply.php">Apply for Job</a>
